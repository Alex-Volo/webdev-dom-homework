...
// Появились умные телефоны, умные дома, умные часы,
// но куда-то стали пропадать умные люди...


// Вопрос: считается ли это инкапсуляцией или больше издевательство 
// над кодом?

/* Сделал как было указано в условиях ДЗ. Но бесконечно вызывать рекурсией
запросы к серверу при 500-й ошибке считаю ошибочным. Плюс такой же 
бесконечно вылезающий alert тоже не добавляет к UX ничего положительного.
Вопрос задал к обсуждению ДЗ 

Update: Ответ получил, alert не нужен. Оставил закоменченным*/
